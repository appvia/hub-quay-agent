...
type GetRegistryNamespaceNameHandlerFunc func(GetRegistryNamespaceNameParams) middleware.Responder

// Handle executing the request and returning a response
func (fn GetRegistryNamespaceNameHandlerFunc) Handle(params GetRegistryNamespaceNameParams) middleware.Responder {
	return fn(params)
}
...
type GetRegistryNamespaceNameHandler interface {
	Handle(GetRegistryNamespaceNameParams) middleware.Responder
}
