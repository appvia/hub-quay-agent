...
type GetRobotsNamespaceHandlerFunc func(GetRobotsNamespaceParams) middleware.Responder

// Handle executing the request and returning a response
func (fn GetRobotsNamespaceHandlerFunc) Handle(params GetRobotsNamespaceParams) middleware.Responder {
	return fn(params)
}
...
type GetRobotsNamespaceHandler interface {
	Handle(GetRobotsNamespaceParams) middleware.Responder
}
