...
type DeleteRegistryNamespaceNameHandlerFunc func(DeleteRegistryNamespaceNameParams, *models.Principal) middleware.Responder

// Handle executing the request and returning a response
func (fn DeleteRegistryNamespaceNameHandlerFunc) Handle(params DeleteRegistryNamespaceNameParams, principal *models.Principal) middleware.Responder {
...
type DeleteRegistryNamespaceNameHandler interface {
	Handle(DeleteRegistryNamespaceNameParams, *models.Principal) middleware.Responder
}
